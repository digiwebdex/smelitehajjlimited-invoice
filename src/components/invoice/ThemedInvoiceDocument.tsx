        ...
        <table className="w-full text-sm" style={{ borderCollapse: "collapse" }}>
          ...
          <thead>
            <tr style={{ borderBottomWidth: '1px', borderBottomColor: t.border_color }}>
              <th className="text-center py-3 font-semibold uppercase tracking-wide text-xs" style={{ color: t.table_header_text }}>
                Description
              </th>
              <th className="text-center py-3 font-semibold uppercase tracking-wide text-xs" style={{ color: t.table_header_text }}>
                Qty
          ...
          <tbody>
            {items.map((item) => (
              <tr key={item.id} style={{ borderBottomWidth: '1px', borderBottomColor: t.border_color }}>
                <td className={cn("py-2.5", "text-center font-medium text-black align-middle uppercase leading-tight")}>
                  {item.title || "—"}
                </td>
                <td className={cn("py-2.5", "text-center text-black align-middle leading-tight")}>{item.qty || 1}</td>
                <td className={cn("py-2.5", "text-center text-black align-middle leading-tight")}>
                  {formatCurrency(item.unit_price || item.amount)}
                </td>
                <td className={cn("py-2.5", "text-center font-semibold text-black align-middle leading-tight")}>
            ...
            <tr>
              <td colSpan={2} />
              <td className={cn("py-1.5", "text-sm leading-tight")} style={{ color: t.subtotal_text_color }}>Subtotal</td>
              <td className={cn("py-1.5", "text-right text-sm font-semibold text-black leading-tight")}>{formatCurrency(invoice.subtotal)}</td>
            </tr>
            {/* Tax */}
            <tr>
              <td colSpan={2} />
              <td className={cn("py-1.5", "text-sm leading-tight")} style={{ color: t.subtotal_text_color }}>Tax</td>
              <td className={cn("py-1.5", "text-right text-sm font-semibold text-black leading-tight")}>{formatCurrency(invoice.vat_amount)}</td>
            </tr>
            {/* Total */}
            <tr>
              <td colSpan={2} />
              <td className={cn("py-1.5", "font-bold text-black leading-tight")}>Total</td>
              <td className={cn("py-1.5", "text-right font-bold text-black leading-tight")}>{formatCurrency(invoice.total_amount)}</td>
            </tr>
            {/* Total Paid */}
            <tr>
              <td colSpan={2} />
              <td className={cn("py-1.5", "font-bold leading-tight")} style={{ color: t.paid_text_color }}>Total Paid</td>
              <td className={cn("py-1.5", "text-right font-bold leading-tight")} style={{ color: t.paid_text_color }}>{formatCurrency(invoice.paid_amount)}</td>
            </tr>
